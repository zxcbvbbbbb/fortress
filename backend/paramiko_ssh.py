...
def ssh_connect(ssh_handler_instance,host_to_user_obj):
    hostname = host_to_user_obj.host.ip_addrss
    port = host_to_user_obj.host.port
    username = host_to_user_obj.remote_users.username
    password = host_to_user_obj.remote_users.password
    try:
    ...
    try:
        ...
        chan.get_pty()
        chan.invoke_shell()
        chan.web_account = ssh_handler_instance.user
